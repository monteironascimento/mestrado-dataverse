...
wget https://github.com/monteironascimento/mestrado-dataverse-metadados/blob/main/ricardo.tsv -O /tmp/ricardo.tsv
curl http://localhost:8080/api/admin/datasetfield/load -H "Content-type: text/tab-separated-values" -X POST --upload-file /tmp/ricardo.tsv
custommetadatablock=True